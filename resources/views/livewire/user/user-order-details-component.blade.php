                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('user.orders')}}" class="btn btn-primary pull-right"> {{trans('message.MyOrders')}}</a>
                                @if($order->status == 'ordered')
                                    <a href="#" wire:click.prevent="cancelOrder" style="margin-right:20px;" class="btn btn-warning pull-right">{{trans('message.CancelOrder')}}</a>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <table class="table">
                            ...
                            @elseif($order->status == 'canceled')
                                <th>{{trans('message.CanceledDate')}}</th>
                        ...
                        <tr>
                            <td>
                                <figure class="itemside align-items-center">
                                    <div class="aside"><img src="{{ asset('assets/images/products') }}/{{$item->product->image}}" alt="{{$item->product->name}}" class="img-sm"></div>
                            ...
                            <td class="text-right">
                                @if($order->status == 'delivered' && $item->rstatus == false)
                                   <a href="{{route('user.review',['order_item_id'=>$item->id])}}">{{trans('message.WriteReview')}}</a>
                                @endif
                            </td>
                        </tr>
