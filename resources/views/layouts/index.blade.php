...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('asets/js/html5shiv.min.js')}}"></script>
    <script src="{{asset('asets/js/respond.min.js')}}"></script>
    <![endif]-->

    <!-- All PLUGINS CSS ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{asset('asets/css/assets.css')}}">

    <!-- TYPOGRAPHY ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{asset('asets/css/typography.css')}}">

    <!-- SHORTCODES ============================================= -->
    <link rel="stylesheet" type="text/css" href="{{asset('asets/css/shortcodes/shortcodes.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('asets/vendors/revolution/css/layers.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('asets/vendors/revolution/css/settings.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('asets/vendors/revolution/css/navigation.css')}}">
...
<script src="{{asset('asets/vendors/bootstrap/js/popper.min.js')}}"></script>
<script src="{{asset('asets/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('asets/vendors/bootstrap-select/bootstrap-select.min.js')}}"></script>
<script src="{{asset('asets/vendors/bootstrap-touchspin/jquery.bootstrap-touchspin.js')}}"></script>
<script src="{{asset('asets/vendors/magnific-popup/magnific-popup.js')}}"></script>
<script src="{{asset('asets/vendors/counter/waypoints-min.js')}}"></script>
<script src="{{asset('asets/vendors/counter/counterup.min.js')}}"></script>
<script src="{{asset('asets/vendors/imagesloaded/imagesloaded.js')}}"></script>
<script src="{{asset('asets/vendors/masonry/masonry.js')}}"></script>
<script src="{{asset('asets/vendors/masonry/filter.js')}}"></script>
<script src="{{asset('asets/vendors/owl-carousel/owl.carousel.js')}}"></script>
<script src="{{asset('asets/js/functions.js')}}"></script>
<script src="{{asset('asets/js/contact.js')}}"></script>
<script src='{{asset('asets/vendors/switcher/switcher.js')}}'></script>
...
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.actions.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.carousel.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.kenburn.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.migration.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.navigation.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.parallax.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
<script src="{{asset('asets/vendors/revolution/js/extensions/revolution.extension.video.min.js')}}"></script>
<script>
